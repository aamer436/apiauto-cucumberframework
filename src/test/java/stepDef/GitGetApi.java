...
String resp = given().relaxedHTTPSValidation().header("Accept", 
"application/vnd.github.mercy-preview+json")
.queryParam("q", "tetris+language:assembly").queryParam("sort", 
"stars").queryParam("order", "desc")
...
// int k=js.getInt("items["+j+"].owner.size()");
